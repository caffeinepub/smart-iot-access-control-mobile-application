  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-6">
      <div>
        ...
        <p className="text-muted-foreground mt-1">Real-time access events and analytics</p>
      </div>
      ...
      <Tabs defaultValue="feed" className="space-y-6">
        ...
        <TabsContent value="feed" className="space-y-4">
          ...
          <Card className="border-accent/20">
            <CardHeader>
              ...
              <CardDescription>
                {filteredEvents.length} events {searchQuery || selectedMethod !== 'all' || selectedUser !== 'all' ? '(filtered)' : ''}
              </CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="analytics">
          <Card className="border-accent/20">
            <CardHeader>
              ...
              <CardDescription>Visual breakdown of access patterns</CardDescription>
            </CardHeader>
            <CardContent>
        ...
        <TabsContent value="advanced" className="space-y-4">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">Deep-dive trends, user breakdowns, and peak-hour analysis</p>
          </div>
