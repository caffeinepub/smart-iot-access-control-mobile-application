...
function useGetCallerUserProfile() {
  ...
  const query = useQuery<{ name: string; email: string; rfidUid: string } | null>({
...
function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  const showOnboarding = isAuthenticated && !profileLoading && isFetched && userProfile !== null && showWalkthrough;
  ...
  return (
    <>
      {showOnboarding && (
        <OnboardingWalkthrough onComplete={markComplete} />
      )}
      {children}
    </>
  );
