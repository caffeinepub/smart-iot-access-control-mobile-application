    ...
    <Card className="bg-card border-border">
      <CardHeader>
        <CardTitle className="flex items-center gap-2 text-base">
          ...
          Emergency Contacts
          <Badge variant="outline" className="ml-auto text-xs">{contacts.length}/3</Badge>
        </CardTitle>
      </CardHeader>
      <CardContent className="space-y-4">
        {contacts.length > 0 && (
          <div className="space-y-2">
            {contacts.map(c => (
              <div key={c.id} className="flex items-center gap-3 p-2.5 rounded-lg bg-background/50 border border-border">
        ...
        {contacts.length < 3 && (
          <div className="space-y-3 pt-2 border-t border-border">
            ...
            <Button size="sm" onClick={handleAdd} className="flex items-center gap-1.5">
        ...
        {contacts.length === 0 && (
          <p className="text-xs text-muted-foreground text-center py-2">
            No emergency contacts configured. Add up to 3 contacts to receive breach alerts.
          </p>
        )}
      </CardContent>
    </Card>
