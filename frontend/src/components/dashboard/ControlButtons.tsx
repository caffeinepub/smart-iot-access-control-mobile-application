...
export default function ControlButtons({ isLocked, emergencyMode }: ControlButtonsProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
      ...
      >
        <img src="/assets/generated/lockdown-icon.dim_128x128.png" alt="Lockdown" className="w-6 h-6 mr-2" />
        Emergency Lockdown
      </Button>
    </div>
  );
