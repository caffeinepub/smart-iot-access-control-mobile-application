...
export default function IntrusionAlertsPanel({ events }: IntrusionAlertsPanelProps) {
            ...
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className="font-semibold text-sm text-destructive">Intrusion Alert</span>
