...
export default function WiFiStrengthIndicator({
  strength,
}: WiFiStrengthIndicatorProps) {
  const getStrengthInfo = (strength: number) => {
    if (strength >= 70) {
      return {
        label: "Strong",
        icon: "/assets/generated/wifi-strong.dim_64x64.png",
        color: "text-accent",
      };
    }
    if (strength >= 40) {
      return {
        label: "Medium",
        icon: "/assets/generated/wifi-medium.dim_64x64.png",
        color: "text-yellow-500",
      };
    }
    return {
      label: "Weak",
      icon: "/assets/generated/wifi-weak.dim_64x64.png",
